...
- Matched original-STEP-verified pairs: 43 recorded by guarded live pilots.
  - Accepted train global indexes:
    `1, 8, 14, 17, 18, 23, 25, 29, 31, 34, 42, 44, 45, 46, 47, 49, 50, 57, 58, 61, 62, 80, 83, 87, 88, 90, 107, 111, 115, 118, 132, 238, 381, 415, 438, 503, 697, 698, 702, 870, 1126, 1170, 1173`.
  - Latest accepted rows: train global indexes 870, 1126, 1170, and 1173,
    manifests `runs/zero_to_cad_live_pilots/deterministic_profile_row870_probe/attempts.jsonl`,
    `runs/zero_to_cad_live_pilots/deterministic_profile_row1126_probe/attempts.jsonl`,
    `runs/zero_to_cad_live_pilots/deterministic_profile_row1170_probe/attempts.jsonl`,
    and `runs/zero_to_cad_live_pilots/deterministic_profile_row1173_probe/attempts.jsonl`.
...
- Next: continue accepted-index guarded forward scans from the 43 accepted
...
- Done: include row 23, row 29, row 31, row 34, row 42, row 44, row 45, row 46, row 47, row 49, row 50, row 57, row 58, row 61, row 62, row 80, row 83, row 87, row 88, row 90, row 107, row 111, row 115, row 118, row 132, row 238, row 381, row 415, row 438, row 503, row 697, row 698, row 702, row 870, row 1126, row 1170, and row 1173 accepted manifests in future
