...
- Matched original-STEP-verified pairs: 507 unique pairs recorded by guarded live pilots under the strict volume + original-STEP trusted policy.
  ...
  - Strict-policy note: `build_zero_to_cad_accepted_index` now re-checks the
    ...
    raised it to 506; row 22106 later raised it to 507.
...
- Next: run accepted-index guarded AI-heavy pilots from the 507 accepted pairs,
