...
- Done: include row 23, row 29, row 31, row 34, and row 42 accepted manifests in future
...
- Next: run the next accepted-index guarded forward scan after row 42 and pick
