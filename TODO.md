...
- Next: continue accepted-index guarded forward scans from the 159 accepted
...
- Done: accept train global indexes 14960, 14963, 26802, and 27306 with
  deterministic profile builders.
- Blocked rows: train global indexes 15058 and 15062 are plannable profile
  rows, but the deterministic builder does not yet evaluate loop-built point
  lists; add safe loop/append evaluation before retrying that bucket.
