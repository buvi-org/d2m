...
- Matched original-STEP-verified pairs: 180 recorded by guarded live pilots.
  ...
  - Latest accepted rows include train global indexes 342, 1536, 1595, 1647,
    ...
    32399, 32464, 32506, 32721, 32722, 32996, 33124, 33145, 33184,
    and 33200,
...
- Next: continue accepted-index guarded forward scans from the 180 accepted
...
- Blocked row: train global index 32470 is plannable but rejected by strict
  original-STEP comparison; treat it as the next side-face counterbore/support
  gap before spending more live attempts on similar L-bracket rows.
