...
- Matched original-STEP-verified pairs: 502 unique pairs recorded by guarded live pilots under the strict volume + original-STEP trusted policy.
  ...
  - Strict-policy note: `build_zero_to_cad_accepted_index` now re-checks the
    ...
    the count to 501; row 21968 later raised it to 502.
...
- Next: run accepted-index guarded AI-heavy pilots from the 502 accepted pairs,
