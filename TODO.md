...
- Matched original-STEP-verified pairs: 505 unique pairs recorded by guarded live pilots under the strict volume + original-STEP trusted policy.
  ...
  - Strict-policy note: `build_zero_to_cad_accepted_index` now re-checks the
    ...
    it to 503; rows 22004 and 22012 later raised it to 505.
...
- Next: run accepted-index guarded AI-heavy pilots from the 505 accepted pairs,
