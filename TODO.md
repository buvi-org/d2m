...
- Matched original-STEP-verified pairs: 30 recorded by guarded live pilots.
  - Accepted train global indexes:
    `1, 8, 14, 17, 18, 23, 25, 29, 31, 34, 42, 44, 45, 46, 47, 49, 50, 57, 58, 61, 62, 80, 83, 87, 88, 90, 107, 111, 115, 118`.
  - Latest accepted row: train global index 115, manifest
    `runs/zero_to_cad_live_pilots/deterministic_box_union_profile_row115_probe/attempts.jsonl`.
...
- Next: continue accepted-index guarded forward scans from the 30 accepted
...
- Done: include row 23, row 29, row 31, row 34, row 42, row 44, row 45, row 46, row 47, row 49, row 50, row 57, row 58, row 61, row 62, row 80, row 83, row 87, row 88, row 90, row 107, row 111, row 115, and row 118 accepted manifests in future
