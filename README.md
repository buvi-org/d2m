...
| Test | Status |
|------|--------|
| `python test_agentic_translator.py` | PASS, 173/173. Includes strict Zero-to-CAD runner policy tests, AI-heavy unsupported-attempt coverage, generated-code discipline checks, and STEP-envelope prompt guards; live LLM runs are separate. |
