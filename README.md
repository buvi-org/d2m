...
| Test | Status |
|------|--------|
| `python test_agentic_translator.py` | PASS, 180/180. Includes strict Zero-to-CAD runner policy tests, AI-heavy unsupported-attempt coverage, generated-code normalization/discipline checks, STEP-envelope prompt guards, sloped-trough/shell planner and prompt coverage, and row-timeout failure handling; live LLM runs are separate. |
